<template>
  <div>
  <svg id="bt-scan" @click="scanQrCode()" xmlns="http://www.w3.org/2000/svg" width="75" height="75" color="white" fill="currentColor" class="bi bi-qr-code-scan" viewBox="0 0 16 16">
